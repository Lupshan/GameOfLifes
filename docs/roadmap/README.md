...
| #  | Step                              | File                                                          | Status      |
|----|-----------------------------------|---------------------------------------------------------------|-------------|
| 15 | Language grammar spec             | [15-language-spec.md](15-language-spec.md)                    | not started |
| 16 | Lexer + parser                    | [16-lexer-parser.md](16-lexer-parser.md)                      | not started |
| 17 | AST → bytecode codegen            | [17-codegen.md](17-codegen.md)                                | not started |
...
| #  | Step                              | File                                                          | Status      |
|----|-----------------------------------|---------------------------------------------------------------|-------------|
| 19 | Backend skeleton                  | [19-backend-skeleton.md](19-backend-skeleton.md)              | not started |
